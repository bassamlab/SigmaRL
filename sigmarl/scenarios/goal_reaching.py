...
from sigmarl.scenarios.observations.observation_provider_gr import (
    ObservationProviderGRSimulation,
)
from sigmarl.scenarios.world_state.world_state_gr.world_state_gr import (
...
class GoalReaching(BaseScenario):
    ...
    def reset_world_at(self, env_index: int = None, agent_index: int = None):
        ...
        self.world_state.update_distances(
            self.world_state.get_agent_state_list(), agent_index, env_index=env_index_2
        )
