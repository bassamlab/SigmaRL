...
[![arXiv](https://img.shields.io/badge/arXiv-2605.16894-b31b1b.svg)](https://arxiv.org/abs/2605.16894)
...
> [!NOTE]
> - Check out our recent work [CBF-Informed MARL](#7-cbf-informed-marl), which has been accepted for publication at IEEE ITSC 2026! We propose a Control Barrier Function (CBF)-informed reward design for Multi-Agent RL (MARL) that converts CBF constraint values under joint MARL actions into a reward signal that explicitly guides safe learning (see also [Fig. 6](#fig-cbf-informed-marl)).
...
<figure>
  <table>
    <tr>
      <td>
        <a id="fig-safety-filter-without"></a>
        <figure>
...
Figure 6: Demonstrating some representative interaction scenarios using the policy learned with our proposed CBF-informed method. See our [CBF-Informed MARL](#7-cbf-informed-marl) for more details.
...
- See additional documentation [here](https://bassamlab.github.io/cpm-lab-ros2-documentation/).
...
<a href="https://arxiv.org/abs/2605.16894" target="_blank"><img src="https://img.shields.io/badge/-Preprint-b31b1b?logo=arXiv"></a> [![Jump to Fig. 6](https://img.shields.io/badge/Jump%20to-Fig.%206-blue)](#fig-cbf-informed-marl) <a href="https://github.com/bassamlab/SigmaRL/tree/1.6.0" target="_blank"><img src="https://img.shields.io/badge/-GitHub-181717?logo=GitHub"></a>
</div>
...
- Improve safety
  - [ ] Integrating Control Barrier Functions (CBFs)
    ...
    - [x] High-Order CBFs (see the TTCBF paper [here](#4-truncated-taylor-cbf-ttcbf))
    - [x] CBF-certified safe RL for collision avoidance with road boundaries (see the CBF-Based Safety Filter paper [here](#5-cbf-based-safety-filter))
    - [x] CBF-informed reward design for safe MARL at an intersection (see the CBF-Informed MARL paper [here](#7-cbf-informed-marl))
  - [ ] Integrating Model Predictive Control (MPC)
- Address non-stationarity
  - [ ] Integrating prioritization (see the XP-MARL paper [here](#2-xp-marl))
- Misc
  - [x] OpenStreetMap support (see guidance [here](#customize-your-own-maps))
  - [x] Contribute our [CPM scenario](#fig-scenario-cpm) as a MARL benchmark scenario in VMAS (see news <a href="https://github.com/proroklab/VectorizedMultiAgentSimulator/releases/tag/1.4.2" target="_blank">here</a>)
  - [x] Update to the latest versions of Torch, TorchRL, and VMAS
  - [x] Support Python 3.11+
  - [x] Deploy in the real world (see the CPM Lab Benchmark paper [here](#6-cpm-lab-benchmark))
